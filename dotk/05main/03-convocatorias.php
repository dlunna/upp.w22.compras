    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link active"  id="v-pills-home-tab"       data-toggle="pill" href="#v-pills-conv1" role="tab" aria-controls="v-pills-home" aria-selected="true">UPP-001-2025</a>
                <a class="nav-link"         id="v-pills-profile-tab"    data-toggle="pill" href="#v-pills-conv2" role="tab" aria-controls="v-pills-profile" aria-selected="false">UPP-002-2025</a>
<!--
 ...
 -->                
        ...
        <div class="col-9">
            <div class="tab-content" id="v-pills-tabContent">
                <?php include('./dotk/05main/03-Convocatorias/UPP-001-2025.html'); ?>
                <?php include('./dotk/05main/03-Convocatorias/UPP-002-2025.html'); ?>
            </div>
        </div>
    </div>
